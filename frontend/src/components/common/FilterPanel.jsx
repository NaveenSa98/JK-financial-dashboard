    ...
    <div className="card mb-6">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-white focus:outline-none bg-gray-100 dark:bg-gray-700 p-1.5 rounded-full"
        >
          {isExpanded ? (
      ...
      {isExpanded && (
        <div className="mt-5 grid grid-cols-1 md:grid-cols-3 gap-6 border-t border-gray-200 dark:border-gray-700 pt-5">
          {/* Year Filter */}
