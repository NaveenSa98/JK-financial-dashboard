...
const ForecastingModule = ({ metricKey = 'revenue', modelType = 'arima', onUpdateComplete = null }) => {
  ...
  const {
    ...
    changeMetric,
    changeModel
  } = useForecasting(metricKey, modelType);
  ...
  useEffect(() => {
    const generateForecast = async () => {
      await generateForecastData({ currency: selectedCurrency });
